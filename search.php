...
<div class="container" style="background-color:#fff; margin-top: 60px; margin-bottom: 280px;" >
	<div class="col-lg-12"><br>
        ...
        <a href="records.php" class="col-lg-1" style="margin-left: 50px"><button class="btn btn-success col-lg-12" name="Back">Back</button></a>
    </div><br>
...
$q="SELECT * FROM employee WHERE profile_ID LIKE '$search%' OR Name LIKE '$search%'OR Designation LIKE '$search%'OR Salary LIKE '$search%'OR Gender LIKE '$search%'";
